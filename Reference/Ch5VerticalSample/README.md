# CH5 - Vanilla Vertical Sample (Ch5VerticalSample)

The sample project uses CH5 library and Vanilla javascript which helps to kick-start your project to build fast, robust, and adaptable web apps with little changes. The project can be depoloyed on TSW Panels, Android and iOS devices.
