...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function styleMediaPlayer() {
      ...
      if (!mp) return;
      var vars = {
        '--ch5-media-player--background-color': 'var(--cream)',
        ...
        '--ch5-media-player--my-music-menu-icon-color': 'var(--gold)',
        '--ch5-media-player--active-icon-color': '#ffffff',
        '--ch5-media-player--active-icon-background-color': 'var(--gold)',
        '--ch5-media-player--icon-button-pressed-background-color': 'var(--cream-dark)',
        '--ch5-media-player--header-icon-background-color': 'var(--cream-dark)',
        '--ch5-media-player--primary-font-color': 'var(--text)',
        '--ch5-media-player--secondary-font-color': 'var(--text-muted, var(--charcoal-3))',
        '--ch5-media-player--default-header-text-color': 'var(--text)',
        '--ch5-media-player--default-track-info-text-color': 'var(--text)',
        '--ch5-media-player--default-provider-text-color': 'var(--text-muted, var(--charcoal-3))',
        '--ch5-media-player--default-progressbar-time-color': 'var(--text-muted, var(--charcoal-3))',
        '--ch5-media-player--progressbar-background-color': 'var(--cream-dark)',
        '--ch5-media-player--progressbar-track-color': 'var(--gold)',
        '--ch5-media-player--default-progressbar-color': 'var(--cream-dark)',
        '--ch5-media-player--loading-indicator-color': 'var(--gold)',
        '--ch5-media-player--player-name-background-color': 'var(--cream-dark)',
        '--ch5-media-player--border-color': 'var(--gold-border)',
        '--ch5-media-player--default-border-color': 'var(--gold-border)',
        '--ch5-media-player--menu-items-border-color': 'var(--gold-border)',
        '--ch5-media-player--default-menu-items-border-color': 'var(--gold-border)',
        '--ch5-media-player--active-menu-list-item-background-color': 'rgba(201, 168, 76, 0.1)',
        '--ch5-media-player--default-album-art-placeholder-color': 'var(--cream-dark)',
        '--ch5-media-player--popup-font-color': 'var(--text)',
        '--ch5-media-player--popup-border-color': 'var(--gold-border)',
        '--ch5-media-player--popup-overlay-background-color': 'rgba(0, 0, 0, 0.5)',
        '--ch5-media-player--popup-active-button-background-color': 'var(--gold)',
        '--ch5-media-player--popup-active-button-color': '#ffffff',
        '--ch5-media-player--popup-input-border-color': 'var(--gold-border)'
      };
      for (var k in vars) {
